/** @file
 *    @brief MAVLink comm protocol testsuite generated from testMavMessage.xml
 *    @see https://mavlink.io/en/
 */
#pragma once
#ifndef TESTMAVMESSAGE_TESTSUITE_H
#define TESTMAVMESSAGE_TESTSUITE_H
...
static void mavlink_test_testMavMessage(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

    mavlink_test_testMavMessage(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_testMavMessage(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
...
#endif // __cplusplus
#endif // TESTMAVMESSAGE_TESTSUITE_H
